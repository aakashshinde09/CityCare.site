    ...
    <div class="relative flex h-16 items-center justify-between">
      ...
      <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
        <div class="flex flex-shrink-0 items-center">
          ...
          <a href="../CityCare"> <h2 class="font-bold text-2xl text-white"><i class="fa-solid fa-stethoscope"></i> City <span class="bg-[#f84525] text-white px-2 rounded-md">Care</span></h2>
          </a>
        </div>
      ...
      <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
        ...
        <div class="relative ml-3">
          ...
          <div class="flex space-x-4">
            <a href="admin_login.jsp" class="hover:bg-gray-700 hover:text-white text-gray-300 rounded-md px-3 py-2 text-sm font-medium"><i class="fa-solid fa-user-tie"></i> Admin</a>
